    ...
    <div id='contact' className='pt-32 container'>
        <div className='grid md:grid-cols-2 gap-10'>
            <div className='space-y-8'>
                ...
                "Thank you for visiting my portfolio! If you’re interested in working together, have any questions, or simply want to chat about potential projects, feel free to get in touch. I’m always excited to connect with creative minds and explore new opportunities.
